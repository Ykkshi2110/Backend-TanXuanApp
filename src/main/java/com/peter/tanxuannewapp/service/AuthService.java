...
public class AuthService {
    ...
    public ResLoginDTO handleLoginForCustomer(ReqLoginDTO reqLoginDTO) {
        ...
        if (currentCustomerDB != null) {
            ResLoginDTO.UserLogin customerLogin = new ResLoginDTO.UserLogin(currentCustomerDB.getId(), currentCustomerDB.getEmail(), currentCustomerDB.getName(), currentCustomerDB.getRole());
    ...
    public ResLoginDTO handleRenewRefreshToken(String refreshToken) {
        ...
        if (currentUserDB != null) {
            ...
            Customer currentCustomerDB = this.customerService.handleGetCustomerByRefreshTokenAndEmail(refreshToken, email);
            if (currentCustomerDB != null) {
                ResLoginDTO.UserLogin customerLogin = new ResLoginDTO.UserLogin(currentCustomerDB.getId(), currentCustomerDB.getEmail(), currentCustomerDB.getName(), currentCustomerDB.getRole());
                resLoginDTO.setUser(customerLogin);
            } else {
    ...
    public void handleLogout() {
        ...
        // Try to log out User first, if not found try Customer
    ...
    public ResLoginDTO.UserAccount handleGetUserAccount() {
        ...
        if (currentUserDB != null) {
            ...
            if (currentCustomerDB != null) {
                ResLoginDTO.UserAccount userAccount = new ResLoginDTO.UserAccount();
                ResLoginDTO.UserLogin userLogin = new ResLoginDTO.UserLogin(currentCustomerDB.getId(), currentCustomerDB.getEmail(), currentCustomerDB.getName(), currentCustomerDB.getRole());
                userAccount.setUser(userLogin);
                return userAccount;
            } else {
